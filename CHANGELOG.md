...
- Promoted the Torch decode, state-engine, transformer-engine, and
  execution-numerics updates from the `1.2.7.alpha` prerelease line.

## [1.2.7.alpha] - 2026-08-25 -- Portable Decoder Numerics Alpha

### Changed

- Added the latest Torch decode, state-engine, transformer-engine, and
  execution-numerics updates from the post-1.2.7 development line.

## [1.2.7] - 2026-08-25 -- Portable Decoder Numerics Stable Release

### Changed

- Promoted the portable-engine device placement, state handling, and
  transformer execution updates from the `1.2.6.alpha` prerelease line.

## [1.2.6.alpha] - 2026-08-25 -- Portable Decoder Numerics Alpha

### Changed

- Added the latest portable-engine device placement, state handling, and
  transformer execution updates from the post-1.2.6 development line.

## [1.2.6] - 2026-08-24 -- Portable Decoder Numerics Stable Release

### Changed

- Promoted the device-placement coverage and backend dispatch validation from
  the `1.2.5.alpha` prerelease line to the stable release.

## [1.2.5.alpha] - 2026-08-24 -- Portable Decoder Numerics Alpha

### Added

- Added the latest device-placement coverage and backend dispatch validation
  from the post-1.2.5 development line.
...
- Expanded architecture execution-numerics metadata and family parity tooling.
- Added decoder benchmark and numerical contract test utilities.

### Fixed

- Preserved family-specific attention scales, rotary geometry, normalization
  placement, fused-QKV layouts, and other execution constants in AEG metadata.
...
[1.2.6.alpha]: https://github.com/iamkaleemsajjad-hue/Aether/releases/tag/v1.2.6.alpha
[1.2.6]: https://github.com/iamkaleemsajjad-hue/Aether/releases/tag/v1.2.6
[1.2.5.alpha]: https://github.com/iamkaleemsajjad-hue/Aether/releases/tag/v1.2.5.alpha
