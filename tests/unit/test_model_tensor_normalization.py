...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("model.transformer.blocks.0.att_proj.weight", (0, "qkv")),
        ("model.transformer.blocks.0.attn_out.weight", (0, "out_proj")),
        ("model.transformer.blocks.0.ff_norm.weight", (0, "ffn_norm")),
        ("model.transformer.blocks.0.ff_proj.weight", (0, "gate_proj")),
        ("model.transformer.blocks.0.ff_out.weight", (0, "ffn")),
